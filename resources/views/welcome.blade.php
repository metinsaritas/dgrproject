...
<html lang="{{ app()->getLocale() }}">
    ...
    <section id="grup-sirketleri">
        <div class="container" style="position: relative; height: 120px; overflow: hidden;">
            <div class="effect left fa fa-angle-left"></div>
            <div class="effect right fa fa-angle-right"></div>
            <div class="logo-holder">
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/01.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/02.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/03.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/04.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/05.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/06.png)"></div></a>
                <a href="#"><div class="logo" style="background-image: url(img/grupsirketleri/07.png)"></div></a>
    ...
    <div style="background-color: #fff4f4;background-image:url(img/social-pattern.png); background-repeat:no-repeat;">
      <div class="container">
        ...
        <div class="row py-4 d-flex align-items-center">
          ...
          <!-- Grid column -->
          <div class="col-md-6 col-lg-7 text-center text-md-right social-holder">

            <!-- Facebook -->
            <a class="fb-ic">
              <a href="#"><i class="fa fa-facebook white-text mr-4"></i></a>
            </a>
            <!-- Twitter -->
            <a class="tw-ic">
            ...
            <!--Instagram-->
            <a class="ins-ic">
              <a href="#"><i class="fa fa-instagram white-text"></i></a>
            </a>
    ...
    <div class="container text-center text-md-left mt-5">
      ...
      <div class="row mt-3 dark-grey-text">
        ...
        <div class="col-md-3 col-lg-4 mx-auto mb-4">
          ...
          <!-- Links -->
          <h6 class="font-weight-bold">Ulaşım</h6>
          <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
          <p>
            <i class="fa fa-map-marker"></i> <b>Merkez Ofis:</b>
            DGR Plaza, Atatürk Mahallesi Girne Caddesi No:47 Ataşehir /İstanbul
            </p>
          <p><i class="fa fa-map-marker"></i> <b>Almanya:</b>
            Bischofsnadel 1 28195 Bremen, Deutschland
          </p>
          
          <p><i class="fa fa-map-marker"></i> <b>Ar-ge:</b>
            İstanbul Üniversitesi Teknokent Entertech, 213 - 214 Üniversite Mahallesi, No: İstanbul Ünv. Avcılar Kampüsü No:2,34320 Avcılar / İstanbul, Türkiye
           </p>
           
           <p><i class="fa fa-map-marker"></i> <b>Teknik Ofis:</b>
            Gürpınar Mah. Gürpınar Cad. Abaylar İş Merkezi No: 16/33 Büyükçekmece / İstanbul
           </p>
        ...
        <div class="col-md-4 col-lg-4 mx-auto mb-md-0 mb-4">
          ...
          <p>
            ...
            <i class="fa fa-phone mr-3"></i><b>Telephone 7/24:</b> +49 173 726 29 12</p>
          <p>
            <i class="fa fa-print mr-3"></i><b>Türkiye:</b> 0212 807 01 90<br/>
            <i class="fa fa-print mr-3"></i><b>Almanya:</b> +49 421 246 777 99
        </p>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script src="js/slidercode.js"type="text/javascript"></script>
    </body>
